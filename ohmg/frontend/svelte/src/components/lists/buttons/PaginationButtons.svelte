...
<div class="btn-container">
    <button class="is-icon-link" disabled={currentOffset < limitInt || loading} on:click={() => {currentOffset = currentOffset - limitInt}}>
        <CaretDoubleLeft />
    </button>
    ...
    {/if}
    <button class="is-icon-link" disabled={currentOffset + limitInt >= total || loading} on:click={() => {currentOffset = currentOffset + limitInt}}>
        <CaretDoubleRight />
    </button>
</div>
