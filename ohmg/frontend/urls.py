...
urlpatterns = [
    ...
    path(
        "item/<str:identifier>",
        RedirectView.as_view(pattern_name="map_summary", permanent=True),
        name="volume_summary",
    ),
    path(
        "loc/volumes/",
        RedirectView.as_view(pattern_name="search", permanent=True),
        name="volumes_list",
    ),
    path(
        "loc/<str:identifier>/",
    ...
    path(
        "viewer/",
        RedirectView.as_view(pattern_name="browse", permanent=False),
        name="viewer_base",
    ),
