...
class OHMGTestCase(TestCase):
    ...
    fixture_default_layerset_categories = Path('ohmg/georeference/fixtures/default-layerset-categories.json')
    fixture_sanborn_layerset_categories = Path('ohmg/georeference/fixtures/sanborn-layerset-categories.json')
    ...
    fixture_document_georef_results_lyr = DATA_DIR / 'fixtures/georeference/fixture-alexandria-la-1892-p2__2-lyr.json'
    fixture_document_georef_results_gcpgroup = DATA_DIR / 'fixtures/georeference/fixture-alexandria-la-1892-p2__2-gcpgroup.json'
    fixture_document_georef_results_gcps = DATA_DIR / 'fixtures/georeference/fixture-alexandria-la-1892-p2__2-gcps.json'
