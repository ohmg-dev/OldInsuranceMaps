...
# ##########################################################
# Run a backup
#  SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./loc_insurancemaps/br/backup.sh $BKP_FOLDER_NAME
#   - BKP_FOLDER_NAME:
...
#
# e.g.:
#  docker exec -it django4loc_insurancemaps sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./loc_insurancemaps/br/backup.sh $BKP_FOLDER_NAME'
# ##########################################################
...
echo "-----------------------------------------------------"
echo "STARTING loc_insurancemaps BACKUP $(date)"
echo "-----------------------------------------------------"
...
./manage.sh backup -i -f -c $PWD/loc_insurancemaps/br/settings_docker.ini --backup-dir /$BKP_FOLDER_NAME/
