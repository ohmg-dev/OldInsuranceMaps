# Generated by Django 2.2.20 on 2023-03-23 11:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lc_item', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=None, null=True)),
                ('lc_resources', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=None, null=True)),
                ('lc_manifest_url', models.CharField(blank=True, max_length=200, null=True, verbose_name='LC Manifest URL')),
                ('extra_location_tags', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=list, null=True)),
                ...
                ('ordered_layers', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=loc_insurancemaps.models.default_ordered_layers_dict, null=True)),
                ('document_lookup', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('layer_lookup', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('sorted_layers', django.contrib.postgres.fields.jsonb.JSONField(default=loc_insurancemaps.models.default_sorted_layers_dict)),
                ('multimask', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ...
                ('locales', models.ManyToManyField(blank=True, null=True, to='places.Place')),
            ],
        ),
        migrations.CreateModel(
            name='Sheet',
