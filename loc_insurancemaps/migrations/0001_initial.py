# Generated by Django 2.2.20 on 2021-11-23 18:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', models.CharField(blank=True, choices=[(1, 'JAN.'), (2, 'FEB.'), (3, 'MAR.'), (4, 'APR.'), (5, 'MAY.'), (6, 'JUN.'), (7, 'JUL.'), (8, 'AUG.'), (9, 'SEP.'), (10, 'OCT.'), (11, 'NOV.'), (12, 'DEC.')], max_length=10, null=True)),
                ...
                ('index_layers', models.ManyToManyField(blank=True, null=True, to='layers.Layer')),
                ('loaded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('regions', models.ManyToManyField(blank=True, null=True, to='base.Region')),
            ],
        ),
        migrations.CreateModel(
            name='Sheet',
